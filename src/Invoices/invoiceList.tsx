...
const FullNameField = ({ source }: { source: string }) => <span>{`Mock FullName (${source})`}</span>;
const AddressField = () => <span>Mock Address</span>;
const InvoiceShow = () => <div>Mock Invoice Details</div>;
