...
export const VehicleForm: React.FC<VehicleFormProps> = ({
  ...
  // Add state for vehicle documents
  ...
  console.log("🔑 Vehicle Form Session Key:", sessionKey);
  ...
  const handleFinalSubmit = useCallback(
    async (data: Partial<Vehicle>) => {
      try {
        ...
        console.log("🚗 Submitting vehicle data with session key:", sessionKey);
        console.log("📄 Documents uploaded:", vehicleDocuments.length);
        console.log("📋 Vehicle data:", data);
        console.log("🔑 Session key for documents:", sessionKey);

        // Submit vehicle data with session key to link uploaded documents
        // Documents are handled separately via the document management API
        // They are linked to this vehicle via the sessionKey (generated by backend)
        const vehicleDataWithSession = sessionKey ? {
          ...data,
          sessionKey: sessionKey
        } : data;
        
        console.log("🚀 Final submission data:", vehicleDataWithSession);
        await onSubmit(vehicleDataWithSession);
      } catch (error) {
        console.error("Submission failed:", error);
      }
    },
    [onSubmit, trigger, sessionKey, vehicleDocuments.length]
  );
  ...
  }, [activeStep, vehicleDocuments, errors.documents?.message, sessionKey]);
