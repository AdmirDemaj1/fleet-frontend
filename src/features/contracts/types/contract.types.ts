...
export interface ContractResponse {
  ...
  euriborTenor?: string;
  euriborInterestImpact?: string;
  prepaymentImpact?: {
    hasPrepayments: boolean;
    count: number;
    totalAmountPrepaid: number;
    monthsSaved: number;
  ...
  euriborImpact?: {
    hasChanges: boolean;
    count: number;
    originalEuriborRate: number;
    currentEuriborRate: number;
    originalInterestRate: number;
    currentInterestRate: number;
    originalMonthlyPayment: number;
    currentMonthlyPayment: number;
    totalMonthlyPaymentChange: number;
    changes?: {
      date: string;
      startingPaymentNumber: number;
      oldEuriborRate: number;
      newEuriborRate: number;
  ...
  totalCurrentPrincipal?: string;
  totalCurrentInterest?: string;
  totalRemainingPrincipal?: string;
  totalRemainingInterest?: string;
